...
Route::get('/api/dashboard/data', [DashboardController::class, 'getDashboardDataApi'])->name('api.dashboard.data');
Route::post('/api/dashboard/refresh/{component}', [DashboardController::class, 'refreshComponent'])->name('api.dashboard.refresh');
Route::post('/api/dashboard/activity-ping', [DashboardController::class, 'activityPing'])->name('api.dashboard.ping');
Route::get('/api/dashboard/notifications', [DashboardController::class, 'getNotifications'])->name('api.dashboard.notifications');
Route::get('/api/dashboard/refresh/live_users', [DashboardController::class, 'getLiveUsers'])->name('api.dashboard.live_users');
Route::get('getBusinessStatistics', [DashboardController::class, 'getBusinessStatistics'])->name('getBusinessStatistics');

...
<head>
    ...
    <title>Shop System - Verify Code</title>
    ...
    <div class="h-screen md:flex bg-gray-300">
        ...
        <div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-emerald-700 to-teal-500 justify-around items-center hidden">
            ...
            <div class="mt-32">
                ...
                <p class="text-white mt-1">Verify your code to continue.</p>
            </div>
            <!-- Decorative circles -->
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center">
            <div class="bg-white p-8 shadow-lg rounded-lg w-full max-w-md">
                ...
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-gray-800 font-bold text-2xl mb-1">Verify Your Code</h1>
                ...
                <form action="{{ route('password.sms.verify') }}" method="POST" class="mb-6">
                    @csrf
                ...
                <div class="text-center">
                    ...
                    <form action="{{ route('password.sms.send') }}" method="POST">
                        @csrf
                        <input type="hidden" name="phone" value="{{ substr($phone, 3) }}">
